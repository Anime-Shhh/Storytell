...
def chat():
    ...
    if session_id not in pdf_sessions:
        return jsonify({'error': 'Invalid session ID. Please upload your book again.'}), 400
...
if __name__ == '__main__':
    print("🌟 Storytell - Your Personal Book Companion")
    print("📚 Starting server on http://localhost:5000")
    print("🔒 Privacy: Books are processed in memory only and never stored permanently")
